            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text('로그인',
                    style:
                        TextStyle(fontSize: 21)), // fontSize 값을 변경하여 텍스트 크기 조절
              ),
            ),
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              const FindPasswordPage()), // 아이디/비밀번호 찾기 페이지로 이동
                    );
                  },
                  child: const Text(
                    '아이디/비밀번호 찾기',
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              const PhoneNumberPage()), // 회원가입 페이지로 이동
                    );
                  },
                  child: const Text(
                    '회원가입',
